 ...
 * @param {Function} config.requestDocument - (db, {[subjectServiceKey], actorUserId, accessContext}) => Promise<dto>
 * @param {Function} config.getDocumentStatus - (db, {[subjectServiceKey], accessContext}) => Promise<dto>
 * @param {Function} config.getDocumentFile - (db, {[subjectServiceKey], accessContext}) => Promise<{storageKey, filename}>
 */
